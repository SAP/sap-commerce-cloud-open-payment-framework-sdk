...
import de.hybris.platform.constants.OpfacceleratoraddonConstants;



/**
 * This is the extension manager of the Opfacceleratoraddon extension.
 */
public class OpfacceleratoraddonManager extends GeneratedOpfacceleratoraddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(OpfacceleratoraddonManager.class.getName());
	 ...
	 */
	public static OpfacceleratoraddonManager getInstance()
	{
		return (OpfacceleratoraddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				OpfacceleratoraddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public OpfacceleratoraddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of OpfacceleratoraddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of OpfacceleratoraddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of OpfacceleratoraddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
