 ...
 */
package de.hybris.platform.opfb2bacceleratoraddon.exception;

/**
 * Custom exception for OPF Accelerator operations. Thrown when an operation within the OPF Accelerator encounters an error.
 */
public class OPFAcceleratorException extends RuntimeException {
     ...
     *         The detail message explaining the reason for the exception.
     * @param t
     *         The cause of the exception, which can be used to retrieve the original exception.
     */
