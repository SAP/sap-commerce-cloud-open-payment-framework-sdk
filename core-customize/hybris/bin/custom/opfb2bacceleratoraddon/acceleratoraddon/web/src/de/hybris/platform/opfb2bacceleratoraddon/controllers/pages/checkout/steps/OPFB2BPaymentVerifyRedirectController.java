...
public class OPFB2BPaymentVerifyRedirectController extends AbstractCheckoutController{
    ...
    public String getPaymentVerificationResult(@RequestParam Map<String, String> requestMap, final Model model)
        ...
        return Opfb2bacceleratoraddonControllerConstants.Views.Pages.MultiStepCheckout.OpfVerifyPaymentPage;
    }

    /**
     * Handles the payment verification redirect by forwarding the request parameters to the OPF payment
     * verification API and returning the result.
     *
     * @param requestMap
     *         requestMap a map of all HTTP request parameters (key → value) passed by the payment gateway;
     */
    ...
    /**
     * Handles the case when a payment verification is cancelled.
     *
     * @param model
     *         model to which attributes may be added.
     * @param redirectAttributes attributes for redirect so parameters can be passed after redirect
     * @return a redirect view string to the OPF payment selection page
     */
