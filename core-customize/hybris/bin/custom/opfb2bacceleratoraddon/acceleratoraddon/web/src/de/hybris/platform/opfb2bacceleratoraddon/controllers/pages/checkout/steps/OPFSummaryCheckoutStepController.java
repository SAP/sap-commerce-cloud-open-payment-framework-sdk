...
@Controller
@RequestMapping(value = "/checkout/multi/opf-summary")
public class OPFSummaryCheckoutStepController extends AbstractCheckoutStepController {
    private static final Logger LOG = Logger.getLogger(OPFSummaryCheckoutStepController.class);
    ...
    public String enterStep(final Model model, final RedirectAttributes redirectAttributes)
        ...
        return Opfb2bacceleratoraddonControllerConstants.Views.Pages.MultiStepCheckout.CheckoutSummaryPage;
    }
    ...
    public String placeOrder(@ModelAttribute("placeOrderForm") final PlaceOrderForm placeOrderForm,
            @RequestParam final boolean termsChecked, final Model model, final RedirectAttributes redirectModel)
    ...
    protected boolean validateOrderForm(final PlaceOrderForm placeOrderForm, final Model model) {
        ...
        if (getCheckoutFlowFacade().hasNoPaymentInfo()) {
            ...
            if (CheckoutPciOptionEnum.DEFAULT.equals(getCheckoutFlowFacade().getSubscriptionPciOption()) && StringUtils.isBlank(
                    securityCode)) {
    ...
    protected void initBinder(final ServletRequestDataBinder binder) {
        ...
        final String formatString = getMessageSource().getMessage(TEXT_STORE_DATEFORMAT_KEY, null, DEFAULT_DATEFORMAT, currentLocale);
