...
<spring:url value="/checkout/multi/opf-summary/placeOrder?termsChecked=true" var="placeOrderUrl" htmlEscape="false"/>
        ...
        <div class="col-sm-6">
            ...
            <multi-checkout:checkoutSteps checkoutSteps="${checkoutSteps}" progressBarId="${progressBarId}">
                ...
                <div class="checkout-review hidden-xs">
                    <label>
                          <spring:theme var="termsAndConditionsHtml" code="checkout.summary.placeOrder.readTermsAndCondition" arguments="${fn:escapeXml(getTermsAndConditionsUrl)}" htmlEscape="false"/>
                ...
                <div class="place-order-form hidden-xs">
                    <form:form action="${placeOrderUrl}" id="placeOrderForm1" modelAttribute="placeOrderForm">
                        <button id="placeOrder" type="submit" class="btn btn-primary btn-block btn-place-order">
                            <spring:theme code="checkout.summary.placeOrder"/>
                        </button>
                        <c:if test="${cartData.quoteData eq null}">
                            <button id="scheduleReplenishment" type="button" class="btn btn-default btn-block scheduleReplenishmentButton">
