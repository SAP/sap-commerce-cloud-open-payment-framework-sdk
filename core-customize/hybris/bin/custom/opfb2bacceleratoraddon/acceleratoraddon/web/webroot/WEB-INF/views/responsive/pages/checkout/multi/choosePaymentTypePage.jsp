...
<%@ taglib prefix="opf-b2b-multi-checkout" tagdir="/WEB-INF/tags/addons/opfb2bacceleratoraddon/responsive/checkout/multi" %>
...
<div class="row">
    <div class="col-sm-6">
        ...
        <multi-checkout:checkoutSteps checkoutSteps="${checkoutSteps}" progressBarId="${progressBarId}">
            <jsp:body>
                <opf-b2b-multi-checkout:paymentTypeForm/>
            </jsp:body>
