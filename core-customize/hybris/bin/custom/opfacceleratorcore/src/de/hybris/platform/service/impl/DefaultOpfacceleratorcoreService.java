...
public class DefaultOpfacceleratorcoreService implements OpfacceleratorcoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultOpfacceleratorcoreService.class);
	...
	{
		return DefaultOpfacceleratorcoreService.class.getResourceAsStream("/opfacceleratorcore/sap-hybris-platform.png");
	}
